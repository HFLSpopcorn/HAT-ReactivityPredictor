...
def Desc_transform(path,new_file_dir):   
    ...
    n=0
    NewMethods = "#p def2tzvpp m062x pop=(full,nboread) stable=opt"
    ...
    for eachfile in (glob('*.gjf') + glob('*.com')):
        ...
        for suffix in suffix_ls:
            if suffix == '+':
                ...
                pass
            Rewrite(new_file_dir,'Desc_sp',fn,suffix,NewMethods,Atom_labels_list,Charge_Spin_Coordinates,addinput)
